      ...
      <div style="max-width: 600px; padding: 10px; margin: 0 auto">
        ...
        <div style="background-color: #fff; color: #000000; margin: 4% 10% 2%; text-align: justify; font-family: sans-serif;">
          ...
          <div style="width: 100%; text-align: center">
            <a style="text-decoration: none; border-radius: 5px; padding: 11px 23px; color: white; background-color: #3498db;" href="http://https://travelandz-backend.onrender.com/api/user/verify-email?token=${user.emailToken}">Verificar mi cuenta</a>
          </div>
